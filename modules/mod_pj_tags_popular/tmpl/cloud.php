...
JLoader::register('TagsHelperRoute', JPATH_BASE . '/components/com_playjoom/helpers/route.php');
?>
...
?>
		<span class="tag">
			<a class="tag-name" style="font-size: <?php echo $fontsize.'em'; ?>" href="<?php echo JRoute::_(PlayJoomHelperRoute::getTagRoute($item->tag_id . ':' . $item->alias)); ?>">
