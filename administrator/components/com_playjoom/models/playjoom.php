 ...
 * PlayJoom Model
 */
class PlayJoomModelPlayJoom extends JModelAdmin
{
        /**
        ...
        {
                // Get the form.
                $form = $this->loadForm('com_playjoom.playjoom', 'playjoom', array('control' => 'jform', 'load_data' => $loadData));
                if (empty($form)) 
                {
                        return false;
                }
        ...
        protected function loadFormData() 
        {
                ...
                $data = JFactory::getApplication()->getUserState('com_playjoom.edit.playjoom.data', array());
                if (empty($data)) 
                {
                        $data = $this->getItem();
                }
