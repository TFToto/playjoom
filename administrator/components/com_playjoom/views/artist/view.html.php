...
class PlayJoomViewArtist extends JViewLegacy
{
        ...
        protected function addToolBar() 
        {
                ...
                if ($isNew) 
                {
                        ...
                        {
                                JToolBarHelper::apply('artist.apply', 'JTOOLBAR_APPLY');
                                JToolBarHelper::save('artist.save', 'JTOOLBAR_SAVE');
                                JToolBarHelper::custom('artist.save2new', 'save-new.png', 'save-new_f2.png', 'JTOOLBAR_SAVE_AND_NEW', false);
                        }
                        JToolBarHelper::cancel('artist.cancel', 'JTOOLBAR_CANCEL');
                }
                else
                {
                        if ($canDo->get('core.edit'))
                        ...
                        if ($canDo->get('core.create')) 
                        {
                                JToolBarHelper::custom('artist.save2copy', 'save-copy.png', 'save-copy_f2.png', 'JTOOLBAR_SAVE_AS_COPY', false);
                        }
                        JToolBarHelper::cancel('artist.cancel', 'JTOOLBAR_CLOSE');
                }
        }
        /**
        ...
        protected function setDocument() 
        {
                ...
                $document->setTitle($isNew ? JText::_('COM_PLAYJOOM_PLAYJOOM_CREATING_ARTIST') : JText::_('COM_PLAYJOOM_PLAYJOOM_EDITING_ARTIST'));
