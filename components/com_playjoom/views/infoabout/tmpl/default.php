...
$preloader_infoabout = '<script type="text/javascript">window.addEvent(\'load\', function() { $(\'preloader_infoabout\').destroy(); $(\'infoabout\').setStyle(\'visibility\', \'visible\');  });</script>';
$document	= & JFactory::getDocument();
$document->addCustomTag($preloader_infoabout);
