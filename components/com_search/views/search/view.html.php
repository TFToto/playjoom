...
class SearchViewSearch extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		if ($params->get('upper_limit_searchword') == '' || $params->get('upper_limit_searchword') == 0) {
			$upper_limit = $lang->getUpperLimitSearchWord();
		} else {
			$upper_limit = $params->get('upper_limit_searchword');
		}

		if ($params->get('lower_limit_searchword') == '' || $params->get('lower_limit_searchword') == 0) {
			$lower_limit = $lang->getLowerLimitSearchWord();
		} else {
			$lower_limit = $params->get('lower_limit_searchword');
		}
		...
		if ($error == null)
		{
			...
			require_once JPATH_SITE . '/components/com_search/helpers/route.php';
