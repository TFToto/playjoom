						...
						else
						{
							...
							if (strpos($file, '/'))
							{
								...
								if (strpos($file, '/'))
								{
									...
									if (file_exists(JPATH_ROOT . "/installation/application/media/$extension/$element/$folder/$file"))
									{
										$includes[] = JURI::root(true) . "/installation/application/media/$extension/$element/$folder/$file";
										break;
									}
									// Try to deal with classical file in a a media subfolder called element
									elseif (file_exists(JPATH_ROOT . "/installation/application/media/$extension/$folder/$element/$file"))
									{
										$includes[] = JURI::root(true) . "/installation/application/media/$extension/$folder/$element/$file";
										break;
									}
									...
									elseif (file_exists(JPATH_ROOT . "/installation/application/media/system/$folder/$element/$file"))
									{
										$includes[] = JURI::root(true) . "/installation/application/media/system/$folder/$element/$file";
										break;
									}
								}
								// Try to deals in the extension media folder
								elseif (file_exists(JPATH_ROOT . "/installation/application/media/$extension/$folder/$file"))
								{
									$includes[] = JURI::root(true) . "/installation/application/media/$extension/$folder/$file";
									break;
								}
								// Try to deal with system files in the template folder
								...
								// Try to deal with system files in the media folder
								elseif (file_exists(JPATH_ROOT . "/installation/application/media/system/$folder/$file"))
								{
									$includes[] = JURI::root(true) . "/installation/application/media/system/$folder/$file";
									break;
								}
							}
							// Try to deal with system files in the media folder
