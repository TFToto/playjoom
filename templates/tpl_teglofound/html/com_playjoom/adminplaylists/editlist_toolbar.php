 ...
 * @author $Author: toto $
 * @headurl $HeadURL: http://dev.teglo.info/svn/playjoom/components/com_playjoom/views/adminplaylists/tmpl/editlist_toolbar.php $
 */
...
?>
			...
			<div class="toolbar-box">			    
				    <div class="toolbar-list" id="toolbar">
                       <ul>
                          <li class="toolbar-button" id="toolbar-save"><a href="#" onclick="javascript:submitbutton()" class="toolbar"><span class="icon-32-save"></span><?php  echo JText::_('COM_PLAYJOOM_PLAYLISTS_SAVE'); ?></a></li>
		    ...
		    <div class="pagetitle icon-48-playjoom"><h2><?php echo JText::_('COM_PLAYJOOM_EDITPLAYLIST_LABEL'); ?></h2>&nbsp;</div>
            </div>  