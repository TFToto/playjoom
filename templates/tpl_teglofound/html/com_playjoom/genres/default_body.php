 ...
 * @author $Author: toto $
 * @headurl $HeadURL: http://dev.teglo.info/svn/playjoom/components/com_playjoom/views/genres/tmpl/default_body.php $
 */
	...
	if($genre_item)
	{
		...
		foreach($genre_item as $j => $item_entrie) {
			...
			if ($j < $this->params->get('NumberOfAlbums')) {
	            ...
	            if (PlayJoomHelper::checkForSampler($item_entrie->album, $item_entrie->artist)) {
