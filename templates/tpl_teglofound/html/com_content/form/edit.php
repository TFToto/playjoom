...
<div class="edit item-page<?php echo $this->pageclass_sfx; ?>">
	...
	<form action="<?php echo JRoute::_('index.php?option=com_content&a_id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate form-vertical">
		<div class="btn-toolbar">
			<div class="btn-group">
				<button type="button" class="small button left" onclick="Joomla.submitbutton('article.save')">
					<i class="fa fa-save fa-1x"></i><?php echo '&nbsp;'.JText::_('JSAVE') ?>
				</button>
			</div>
			<div class="btn-group">
				<button type="button" class="small button left" onclick="Joomla.submitbutton('article.cancel')">
					<i class="fa fa-times fa-1x"></i><?php echo '&nbsp;'.JText::_('JCANCEL') ?>
				</button>
			</div>
			<?php if ($params->get('save_history', 0)) : ?>
			<div class="btn-group">
				<div class="small button right">
					<i class="fa fa-undo fa-1x"></i><?php echo '&nbsp;'.$this->form->getInput('contenthistory'); ?>
				</div>
			</div>
			<?php endif; ?>
		</div>
...
<div class="section-container auto" data-section>
	<section class="active">
		<p class="title" data-section-title><a href="#<?php echo JText::_('JEDITOR') ?>"><?php echo JText::_('JEDITOR') ?></a></p>
	...
	<section>
		<p class="title" data-section-title><a href="#<?php echo JText::_('COM_CONTENT_IMAGES_AND_URLS') ?>"><?php echo JText::_('COM_CONTENT_IMAGES_AND_URLS') ?></a></p>
		<div class="content" data-section-content>
			<div class="control-group">
				<div class="control-label">
	...
	<section>
		<p class="title" data-section-title><a href="#<?php echo JText::_('COM_CONTENT_PUBLISHING') ?>"><?php echo JText::_('COM_CONTENT_PUBLISHING') ?></a></p>
		<div class="content" data-section-content>
			<div class="control-group">
				<div class="control-label">
	...
	<section>
		<p class="title" data-section-title><a href="#<?php echo JText::_('JFIELD_LANGUAGE_LABEL') ?>"><?php echo JText::_('JFIELD_LANGUAGE_LABEL') ?></a></p>
		<div class="content" data-section-content>
			<div class="control-group">
				<div class="control-label">
	...
	<section>
		<p class="title" data-section-title><a href="#<?php echo JText::_('COM_CONTENT_METADATA') ?>"><?php echo JText::_('COM_CONTENT_METADATA') ?></a></p>
		<div class="content" data-section-content>
			<div class="control-group">
				<div class="control-label">
