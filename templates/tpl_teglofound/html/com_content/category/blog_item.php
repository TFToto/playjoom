...
<?php echo JLayoutHelper::render('teglofound.content.intro_image', $this->item); ?>


<?php if (!$params->get('show_intro')) : ?>
	<?php echo $this->item->event->afterDisplayTitle; ?>
<?php endif; ?>
<?php echo $this->item->event->beforeDisplayContent; ?> <div class="introtext"><?php echo $this->item->introtext; ?>
...
<?php if ($params->get('show_readmore') && $this->item->readmore) :
	...
	elseif ($params->get('show_readmore_title', 0) == 0) :
	    ...
	    echo '<i class="more-icon fa fa-ellipsis-h fa-1x"></i> ';
		//echo JHtml::_('string.truncate', ($this->item->title), $params->get('readmore_limit'));
	endif; ?>
