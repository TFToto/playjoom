...
function pagination_item_active(&$item)
{
	...
	if (is_numeric($item->text)) {
		return "<li class=\"hide-for-small\"><a title=\"" . $item->text . "\" href=\"" . $item->link . "\" class=\"pagenav\">" . $item->text . "</a><li>";
	} else {
...
function pagination_item_inactive(&$item)
{
	...
	{
		return '<li class="current show-for-small"><a>' . $item->text . '</a></li><li class="current hide-for-small"><a>' . $item->text . '</a></li>';
	}
