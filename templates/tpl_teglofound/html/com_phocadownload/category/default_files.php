...
if (!empty($this->files)) {	
	foreach ($this->files as $v) {
		...
		if ($rightDisplay == 1) {
			...
			$pdButtonDownload = str_replace('class=""', 'class="right small button"', $linkDownloadB) . JText::_('COM_PHOCADOWNLOAD_DOWNLOAD') .$linkDownloadE;
			...
			if ($this->t['display_detail'] == 1) {
				...
				$pdButtonDetails = '<a class="right small secondary button btn-info" '.$overlib.' href="#">'. JText::_('COM_PHOCADOWNLOAD_DETAILS').'</a>';
				//$pdButtonDetails .= '</div>';
				...
				//$pdButtonDetails = '<div class="pd-button-details">';
				$pdButtonDetails = '<a class="right small secondary button btn-info pd-modal-button" href="'.$detailLink.'" rel="'. $buttonDOptions.'">'. JText::_('COM_PHOCADOWNLOAD_DETAILS').'</a>';
				//$pdButtonDetails .= '</div>';
			} else {
				//$pdButtonDetails = '';
			}
			...
			if ($v->textonly == 1) {
				...
				if ($this->t['display_specific_layout'] == 0) {
					...
					echo $pdFileDescTop;
					echo $pdFile;
					echo $pdButtonDownload.$pdButtonDetails;
